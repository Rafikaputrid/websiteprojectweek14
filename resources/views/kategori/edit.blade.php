...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <font face="Maiandra GD" style="text-align:center"><h1>EDIT DATA KATEGORI</h1></font>
            <br>
            ...
            <form action="/kategori/update" method="post">
                ...
                <div class="form-group row">
                    <label for="inputNama" class="col-sm-2 col-form-label">Nama Kategori</label>
                        <div class="col-sm-10">
                            <input type="text" name="kategori" class="form-control" id="inputNama" value="{{ $k->NAMA_KATEGORI}}">
                        </div>
                </div>
